...
## 1. پذیرش شرایط
با دانلود، نصب یا استفاده از پارچ لینوکس، شما موافقت می‌کنید که به این شرایط خدمات پایبند باشید. اگر با این شرایط موافق نیستید، از نرم‌افزار استفاده نکنید.

## 2. اعطای مجوز
پارچ لینوکس تحت مجوز GPL-3 توزیع می‌شود. شما مجوزی غیر انحصاری، جهانی و بدون حق امتیاز برای استفاده، تغییر و توزیع نرم‌افزار، با رعایت شرایط این مجوز دریافت می‌کنید.

## 3. مسئولیت‌های کاربر
- شما موافقت می‌کنید که از پارچ لینوکس مطابق با تمام قوانین و مقررات مربوطه استفاده کنید.
- شما مسئول حفظ محرمانگی اطلاعات حساب کاربری خود و تمام فعالیت‌هایی هستید که تحت حساب شما انجام می‌شود.

## 4. عدم ضمانت
پارچ لینوکس به «همین شکلی که هست» ارائه می‌شود و هیچ‌گونه ضمانتی از هیچ نوع ندارد. توسعه‌دهندگان تضمین نمی‌کنند که نرم‌افزار بدون خطا، ایمن یا مطابق با نیازهای شما باشد.

## 5. محدودیت مسئولیت
در هیچ شرایطی توسعه‌دهندگان یا مشارکت‌کنندگان پارچ لینوکس مسئول خسارات ناشی از استفاده یا عدم توانایی در استفاده از نرم‌افزار نخواهند بود، حتی اگر از احتمال چنین خساراتی مطلع شده باشند.

## 6. مشارکت‌ها
اگر شما به پارچ لینوکس کمک کنید (مانند کد، مستندات)، شما به توسعه‌دهندگان مجوزی دائمی، جهانی و بدون حق امتیاز برای استفاده، تغییر و توزیع مشارکت‌های خود اعطا می‌کنید.

## 7. تغییرات در شرایط
توسعه‌دهندگان حق دارند در هر زمان این شرایط خدمات را تغییر دهند. تغییرات بلافاصله پس از انتشار در وب‌سایت مؤثر خواهند بود. ادامه استفاده شما از پارچ لینوکس به منزله پذیرش شرایط تغییر یافته است.
